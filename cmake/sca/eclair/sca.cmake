...
if(ECLAIR_SUMMARY_JSON)
  list(APPEND ECLAIR_REPORT_ADDITIONAL_OPTIONS "-summary_json=${ECLAIR_OUTPUT_DIR}/summary_json")
endif()
...
if(ECLAIR_FULL_JSON)
  list(APPEND ECLAIR_REPORT_ADDITIONAL_OPTIONS "-full_json=${ECLAIR_OUTPUT_DIR}/report_full_json")
endif()
