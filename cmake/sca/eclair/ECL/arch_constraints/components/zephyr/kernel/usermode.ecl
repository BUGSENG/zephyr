-file_tag+={ZEPHYR_KERNEL_USERMODE_FILES, "^zephyr/include/zephyr/kernel/obj_core\\.h$"}
-file_tag+={ZEPHYR_KERNEL_USERMODE_FILES, "^zephyr/include/zephyr/sys/internal/kobject_internal\\.h$"}
-file_tag+={ZEPHYR_KERNEL_USERMODE_FILES, "^zephyr/include/zephyr/sys/kobject\\.h$"}
-file_tag+={ZEPHYR_KERNEL_USERMODE_FILES, "^zephyr/kernel/obj_core\\.c$"}
-file_tag+={ZEPHYR_KERNEL_USERMODE_FILES, "^zephyr/kernel/userspace_handler\\.c$"}
...
-file_tag+={ZEPHYR_KERNEL_USERMODE_FILES, "^zephyr/include/zephyr/internal/syscall_handler\\.h$"}
-file_tag+={ZEPHYR_KERNEL_USERMODE_FILES, "^zephyr/include/zephyr/syscall\\.h$"}
-file_tag+={ZEPHYR_KERNEL_USERMODE_FILES, "^.*/build/zephyr/include/generated/zephyr/syscall_list\\.h$"}
-file_tag+={ZEPHYR_KERNEL_USERMODE_FILES, "^zephyr/kernel/userspace\\.c$"}
