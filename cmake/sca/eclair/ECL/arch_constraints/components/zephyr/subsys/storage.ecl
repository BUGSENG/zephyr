-file_tag+={ZEPHYR_SUBSYS_STORAGE_FILES, "^zephyr/subsys/storage/.*$"}
-file_tag+={ZEPHYR_SUBSYS_STORAGE_FILES, "^zephyr/include/zephyr/storage/flash_map\\.h$"}
-file_tag+={ZEPHYR_SUBSYS_STORAGE_FILES, "^zephyr/include/zephyr/storage/stream_flash\\.h$"}
