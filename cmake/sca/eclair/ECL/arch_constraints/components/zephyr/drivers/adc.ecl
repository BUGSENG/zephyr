-file_tag+={ZEPHYR_DRIVERS_ADC_FILES, "^zephyr/include/zephyr/drivers/adc\\.h$"}
-file_tag+={ZEPHYR_DRIVERS_ADC_FILES, "^zephyr/drivers/adc/.*$"}
-file_tag+={ZEPHYR_DRIVERS_ADC_FILES, "^zephyr/include/zephyr/drivers/adc/.*$"}
